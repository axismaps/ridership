...
const dataMethods = {
  ...
  getData(callback) {
    ...
    Promise.all([
      ...
      d3.json('https://transitcenter-admin.carto.com/api/v2/sql?q=SELECT%20*%20FROM%20ntd'),
      d3.json('data/states.json'),
      d3.json('https://transitcenter-admin.carto.com/api/v2/sql?q=SELECT%20*%20FROM%20ntd_msa'),
      d3.json('https://transitcenter-admin.carto.com/api/v2/sql?q=SELECT%20*%20FROM%20ntd_national'),
